...
export function MobileExploreSheet({
  ...
  return (
    <aside
      ...
      className="fixed inset-x-0 bottom-0 z-20 pointer-events-auto flex flex-col sm:hidden transition-all duration-300 ease-out"
      style={{
        maxHeight: isExpanded ? '75vh' : '135px',
      }}
    >
      <div className="bg-white/98 backdrop-blur-2xl border-t border-slate-200/90 rounded-t-[28px] shadow-2xl shadow-slate-900/20 flex flex-col h-full overflow-hidden">
        ...
        <div
          ...
          className="pt-2.5 pb-2 px-4 flex flex-col items-center cursor-pointer select-none shrink-0 active:bg-slate-50/80 transition-colors"
        >
          ...
          <div className="w-full flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="text-xs font-bold text-slate-900 tracking-tight flex items-center gap-1.5">
                ...
                <Badge variant="outline" className="text-[9px] px-1.5 py-0 text-teal-700 bg-teal-50 border-teal-200 font-bold">
                  FIAP NEXT
                </Badge>
              </span>
            </div>
        ...
        {/* 1. PEAK QUICK ACTIONS (Always visible: Waze style 4-pill row) */}
        <div className="px-3 pb-3 flex items-center justify-between gap-1.5 shrink-0">
          {/* Acolhimento */}
          <button
            type="button"
            onClick={(e) => {
        ...
        {/* 2. EXPANDED CONTENT (Scrollable when expanded) */}
        {isExpanded && (
          <div className="flex-1 overflow-y-auto px-4 pb-8 space-y-5 animate-in fade-in slide-in-from-bottom-2 duration-200">
            {/* Seção A: Mais Ações e Painel */}
            <div className="pt-1">
              <h4 className="text-[11px] font-bold uppercase tracking-wider text-slate-500 mb-2.5 flex items-center gap-1.5">
                <Sparkles className="w-3.5 h-3.5 text-blue-600" />
                <span>Recursos & Operação</span>
              </h4>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-[10px] text-slate-500 truncate">Fluxo em tempo real</div>
                  </div>
                </button>
                ...
                <button
                  ...
                  className="flex items-center gap-2.5 p-3 rounded-2xl bg-blue-50/60 hover:bg-blue-100/60 border border-blue-200/80 text-left transition-all active:scale-98"
                >
            ...
            {/* Seção C: Locais Correspondentes */}
            {selectedCategory !== 'all' && (
            ...
            {/* Seção D: Acontecendo Agora (Ao Vivo) */}
